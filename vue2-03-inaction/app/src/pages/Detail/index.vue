        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            ...
            <div class="cartWrap">
              ...
              <div class="add">
                <!-- 以前咱们的路由跳转：从A路由跳转到B路由，这里在加入购入车，进行路由跳转之前，
                发请求把你购买的产品信息通过请求的形式通知服务器，服务器进行相应的存储 -->
...
export default {
  ...
  methods: {
    // 产品的售卖属性值切换高亮
    changeActive(saleAttrValue, saleAttrValueArr) {
      saleAttrValueArr.forEach((item) => {
        item.isChecked = "0";
      });
    ...
    async addShopCart() {
      try {
        ...
        this.$router.push({
          name: "addcartsuccess",
          // 直接传递一个对象，也是可以的，只是在浏览器会显示 http://localhost:8080/#/addcartsuccess?skuInfo=%5Bobject%20Object%5D
